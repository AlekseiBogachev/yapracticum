...
1. [**Выпускной проект**](15%20Выпускной%20проект) - Решение задачи регрессии, применение моделей градиентного бустинга: **CatBoost** и **LightGBM**, настройка гиперпараметров с **Optuna**, анализ остатков, оценка значимости признаков с **Shap**.
